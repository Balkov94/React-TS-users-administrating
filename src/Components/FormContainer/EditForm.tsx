...
function EditForm({ editUser, handleFormData ,handleEditMode}: IFormParentProps) {
          ...
          <div className={styles.registerForm}>
               <form action="submit" onSubmit={sendFormData}>
                    ...
                    <div>
                         ...
                         <input onChange={handleInputs} type="text" name="username" id="username" value={editObject?.username} readOnly={true} />
                    </div>
                    <div>
